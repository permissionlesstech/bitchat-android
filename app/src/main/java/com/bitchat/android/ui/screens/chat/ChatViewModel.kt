...
import com.bitchat.android.ui.screens.chat.utils.ChatViewModelUtils
...
import com.bitchat.android.ui.screens.geohash.GeohashViewModel
...
import com.bitchat.android.ui.screens.chat.utils.colorForPeerSeed
...
class ChatViewModel(
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as NostrSubscriptionManager
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as NostrDirectMessageHandler
    ...
    fun startPrivateChat(peerID: String) {
        ...
        if (success) {
            ...
            try {
                val seen = SeenMessageStore.getInstance(getApplication())
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = ConversationAliasResolver.resolveCanonicalPeerID(
    ...
    fun sendMessage(content: String) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = ConversationAliasResolver.resolveCanonicalPeerID(
    ...
    fun panicClearAllData() {
        ...
        try {
            ...
            try {
                val store = GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
